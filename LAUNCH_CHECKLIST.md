...
- Keep `connect@izoduwa.gallery` as the only public email address for collector, gallery, museum, curator, institutional, acquisition, exhibition, collaboration, publication, partnership, and private viewing requests.
...
- Test the contact workflow regularly and update inquiry copy as gallery operations mature.
