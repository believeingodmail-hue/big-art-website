...
1. Upload the repository root directly to Netlify.
2. Use `izoduwa.gallery` as the production custom domain.
3. Leave the build command empty.
4. Use the repository root as the publish directory if Netlify asks for one.
