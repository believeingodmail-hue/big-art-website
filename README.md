...
1. Upload this folder directly to Netlify.
2. Set the custom domain to `izoduwa.gallery`.
3. No build command is required.
4. No publish directory is required unless Netlify asks; use the repository root.
