...
const openActiveArtwork = document.querySelector('[data-open-active-artwork]');
const artworkDialog = document.querySelector('[data-artwork-dialog]');
const dialogClose = document.querySelector('[data-dialog-close]');
const dialogPreview = document.querySelector('[data-dialog-preview]');
const dialogTitle = document.querySelector('[data-dialog-title]');
const dialogNumber = document.querySelector('[data-dialog-number]');
const dialogMedium = document.querySelector('[data-dialog-medium]');
const dialogYear = document.querySelector('[data-dialog-year]');
const dialogScale = document.querySelector('[data-dialog-scale]');
const dialogDetail = document.querySelector('[data-dialog-detail]');
const dialogInquire = document.querySelector('[data-dialog-inquire]');
...
function openArtworkDialog(card) {
  populateDialog(card);
...
const galleryRoom = document.querySelector('[data-gallery-room]');
const roomCaption = document.querySelector('[data-room-caption]');
const roomCopy = {
